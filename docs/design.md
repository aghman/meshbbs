...
**Status:** Draft v0.17 — file catalogs, and Phase 3 code-complete
**Date:** 2026-08-08
...
**The door API has its own document: [doors.md](doors.md), which specifies §9.1's contract at the wire level and records where implementation narrowed §9.1.1, §9.2, §9.4 and §11.5.**
